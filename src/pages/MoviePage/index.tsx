            ...
            <div className="movie-page-wrapper">
                ...
                <div className="movie-page-title-wrapper content-wrapper">
                    ...
                    <div className="movie-page-title-info-wrapper">
                        ...
                        <p>{this.props.moviePageState && this.props.moviePageState.rating ? `${this.props.moviePageState.releaseDate} ${String.fromCharCode(183)} ${this.props.moviePageState.rating * 10}% User Score` : "" }</p>
